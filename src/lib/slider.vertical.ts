...
export class VerticalSlider extends Slider{
    ...
    down($event:any,slideContainer:HTMLElement,slideBox:HTMLElement){
        ...
        super.slideDown($event.clientY,parseFloat(getComputedStyle(slideContainer).height.slice(0,getComputedStyle(slideContainer).height.length-2)));
